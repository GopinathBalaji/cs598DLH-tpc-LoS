...
from models.initialise_arguments_bdeleon2 import initialise_tpc_argumentsMIMIC
import torch
...
class TPC(ExperimentTemplate):
    def setup(self):
        ...
        self.load_checkpoint("tpc_mimic_los_model")
        return

def loadRunTPCMIMICTestLoS():
    c = initialise_tpc_argumentsMIMIC()
    c['exp_name'] = 'TPC'
    c=best_tpc(c)
